...
class TransactionServiceTest {
    ...
    void checkForFraud_Test_No_Fraud_Detected() {
        ...
        assertDoesNotThrow(() -> transactionService.checkForFraud_DebitAccount(transactionDTO));
    }
    ...
    void checkForFraud_Test_1Second_Fraud_Detected() {
        ...
        assertThrows(ResponseStatusException.class, () -> transactionService.checkForFraud_DebitAccount(transactionDTO));
    }
    ...
    void checkForFraud_Test_Account_Frozen() {
        ...
        try {
            transactionService.checkForFraud_DebitAccount(transactionDTO);
